...
const juiceProducts = [
	{
		name: "AF53 CAF",
		image: "https://www.secureclosures.com/wp-content/uploads/2019/05/AF53-CAF.jpg",
		description:
			"AF53 CAF is a premium 53mm closure for juice jars, featuring a tamper-evident band, leak-proof seal, and robust design for repeated use.",
		specs: [
			...
			{ label: "Applications", value: "Juice Jars, Bulk Juice Packaging" },
		],
	},
	{
		name: "AF53 HF-HD",
		image: "https://www.secureclosures.com/wp-content/uploads/2019/05/AF53-HF-HD.jpg",
		description:
			"AF53 HF-HD is a heavy-duty 53mm closure for juice jars, offering enhanced durability, tamper-evidence, and a leak-proof seal for high-volume packaging.",
		specs: [
			{ label: "Neck Finish", value: "53mm" },
			{ label: "Material", value: "Food Grade Polypropylene (PP)" },
			{ label: "Tamper Evidence", value: "Breakable Band" },
			{ label: "Features", value: "Heavy-Duty, Leak-Proof, Custom Colors" },
			{ label: "Applications", value: "Juice Jars, Bulk Juice Packaging" },
		],
	},
	{
		name: "AF53 CAF-HD",
		image: "https://www.secureclosures.com/wp-content/uploads/2019/05/AF53-CAF-HD.jpg",
		description:
			"AF53 CAF-HD is a high-durability 53mm closure for juice jars, combining tamper-evidence, leak-proof performance, and robust construction for demanding applications.",
		specs: [
			{ label: "Neck Finish", value: "53mm" },
			{ label: "Material", value: "Food Grade Polypropylene (PP)" },
			{ label: "Tamper Evidence", value: "Breakable Band" },
			{ label: "Features", value: "High-Durability, Leak-Proof, Custom Colors" },
			{ label: "Applications", value: "Juice Jars, Bulk Juice Packaging" },
		],
	},
	{
		name: "S1881WF001",
		image: "https://www.secureclosures.com/wp-content/uploads/2019/05/S1881WF001.jpg",
		description:
			"S1881WF001 is a specialized closure for juice bottles, designed for secure sealing, tamper-evidence, and compatibility with high-speed filling lines.",
		specs: [
			{ label: "Neck Finish", value: "Custom" },
			{ label: "Material", value: "Food Grade Polypropylene (PP)" },
			{ label: "Tamper Evidence", value: "Breakable Band" },
			{ label: "Features", value: "High-Speed Compatible, Leak-Proof, Custom Colors" },
			{ label: "Applications", value: "Juice Bottles, Bulk Juice Packaging" },
		],
	},
];

export default function JuiceClosuresPage() {
		...
		<main className="min-h-screen">
			...
			>
				...
				<p className="text-xl md:text-2xl font-semibold text-blue-100 max-w-2xl mx-auto mb-8">
					Tamper-evident, leak-proof, and high-performance closures for juice packaging.
				</p>
				<Link
					href="/contact"
			...
			<section className="max-w-7xl mx-auto px-4 py-12">
				<h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-10 text-center tracking-tight">
					Our Juice Closures Range
				</h2>
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
					{juiceProducts.map((prod, idx) => (
						<div
							key={prod.name}
						...
						>
							...
							<Link
								href={`mailto:sales@secureclosures.com?subject=Enquiry%20for%20${encodeURIComponent(prod.name)}%20Juice%20Closure&body=${encodeURIComponent(`Hello Secure Closures Team,  I am interested in the ${prod.name} juice closure. Please provide more details and pricing for the following specifications: ${prod.specs.map(s => `- ${s.label}: ${s.value}`).join(' ')}\n Thank you. `)}`}
								target="_blank"
