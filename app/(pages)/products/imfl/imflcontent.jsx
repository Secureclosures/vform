...
const imflProducts = [
  {
    name: "NIP LID",
    image: "https://www.secureclosures.com/wp-content/uploads/2021/12/niplid.jpg",
    description:
      "NIP LID is designed for IMFL nip bottles (90ml/180ml), featuring a secure tamper-evident band, leak-proof seal, and customizable branding. Widely used for spirits and liquor packaging.",
    specs: [
      { label: "Neck Finish", value: "22mm / 25mm / 28mm" },
      { label: "Material", value: "Food Grade Polypropylene (PP)" },
      { label: "Tamper Evidence", value: "Breakable Band" },
      { label: "Branding", value: "Custom Colors, Embossing, Printing" },
      { label: "Applications", value: "IMFL Nip Bottles, Spirits" },
    ],
  },
  {
    name: "VF 47",
    image: "https://www.secureclosures.com/wp-content/uploads/2021/12/vf47.jpg",
    description:
      "VF 47 closure is engineered for high-speed bottling lines, offering robust tamper-evidence, superior sealing, and a large surface for branding. Trusted by leading IMFL brands.",
    specs: [
      { label: "Neck Finish", value: "25mm / 28mm" },
      { label: "Material", value: "Food Grade Polypropylene (PP)" },
      { label: "Tamper Evidence", value: "Breakable Band" },
      { label: "Branding", value: "Custom Colors, Embossing, Printing" },
      { label: "Applications", value: "IMFL, Spirits, Liquor" },
    ],
  },
  {
    name: "VF 59",
    image: "https://www.secureclosures.com/wp-content/uploads/2021/12/VF59.jpg",
    description:
      "VF 59 closure is designed for premium IMFL packaging, featuring advanced tamper-evidence, smooth application, and a large branding area. Ensures product integrity and shelf appeal.",
    specs: [
...
export default function IMFLPage() {
  ...
  return (
    <main className="min-h-screen">
      <Toaster />
      {/* Hero Section */}
      <section className="relative overflow-hidden flex flex-col items-center justify-center text-center pt-30 md:pt-40 pb-12 min-h-[60vh] sm:min-h-[70vh]" style={{ paddingTop: 'clamp(15rem, 12vw, 8rem)' }}>
        <div className="absolute inset-0 -z-10">
          <Image
            src="/producthero.webp"
            alt="IMFL Closures Hero"
            fill
            priority
        ...
        <p className="text-xl md:text-2xl font-semibold text-blue-100 max-w-2xl mx-auto mb-8">
          Secure, tamper-evident, and customizable closures for the Indian Made Foreign Liquor industry.
        </p>
        <Link href="/contact" className="inline-block px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-extrabold text-lg shadow-lg hover:from-blue-700 hover:to-cyan-600 focus:ring-4 focus:ring-cyan-300 transition-all duration-200">
          Request a Quote
        </Link>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-10 text-center tracking-tight">
          Our IMFL Product Range
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {imflProducts.map((prod, idx) => (
            <div
              key={prod.name}
            ...
            >
              ...
              <Link
                href={`mailto:sales@secureclosures.com?subject=Enquiry%20for%20${encodeURIComponent(prod.name)}%20IMFL%20Closure&body=${encodeURIComponent(`Hello Secure Closures Team,  I am interested in the ${prod.name} IMFL closure. Please provide more details and pricing for the following specifications: ${prod.specs.map(s => `- ${s.label}: ${s.value}`).join(' ')}\n Thank you. `)}`}
                target="_blank"
      ...
      <section className="py-16 bg-gradient-to-r from-blue-700 to-cyan-500 text-white text-center">
        ...
        <Link href="/contact" className="inline-block px-8 py-4 rounded-xl bg-white text-blue-700 font-extrabold text-lg shadow-lg hover:bg-blue-100 focus:ring-4 focus:ring-cyan-300 transition-all duration-200">
          Get in Touch
        </Link>
      </section>
    </main>
